    ...
    public static class SimplifyTools
    {
        ...
        public static Vertices CollinearSimplify(Vertices vertices, float collinearityTolerance = 0)
        {
            ...
            for (int i = 0; i < vertices.Count; i++)
            {
                ...
                if (MathHelper.IsCollinear(ref prev, ref current, ref next, collinearityTolerance))
                    continue;
        ...
        public static Vertices ReduceByArea(Vertices vertices, float areaTolerance)
        {
            ...
            for (int i = 0; i < vertices.Count; ++i, v2 = v3)
            {
                ...
                float old1;
                MathHelper.Cross(ref v1, ref v2, out old1);

                float old2;
                MathHelper.Cross(ref v2, ref v3, out old2);

                float new1;
                MathHelper.Cross(ref v1, ref v3, out new1);
